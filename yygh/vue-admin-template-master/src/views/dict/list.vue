  ...
      <div class="app-container">
    <div class="el-toolbar">
      <div class="el-toolbar-body"
        ...
        <el-button type="text"
                   @click="importData"><i class="fa fa-plus" /> 导入</el-button>
...
export default {
  ...
  methods: {
    ...
    //数据字典列表
    getDictList(id) {
      dict.dictList(id).then((respoens) => {
        this.list = respoens.data
      })
    },
    getChildrens(tree, treeNode, resolve) {
      dict.dictList(tree.id).then((respoens) => {
        resolve(respoens.data)
      })
    },
  },
}
